...
**UPDATE**: GitHub Classroom seems to be suffering some [temporary backend issues](https://github.com/orgs/community/discussions/43783).  For now, we will have to do without GitHub Classroom.  That means you will have to create your own repository (please have just **one member** of the team do this).  Please create a new repository with the name CS1632_Spring2023_\[TeamName\] (please replace \[TeamName\] with the team name you put on your partnership contract.  Please make sure your repository is set to **Private** (otherwise you would be abetting **plagiarism**).  On your new forked repository, please go to the "Settings > Collaborators and teams" menu and add your partner as collaborator, as well as me (ID: wonsunahn).  I will ask you later to add the ID of our TA when I obtain it.  You are going to work on this new repository for the rest of the semester, or until GitHub Classroom is fixed.  Clone the new repository on to your laptops.  Then copy the contents of the course repository on to the cloned repository, commit, and push.  If you are unfamiliar with Git, again please refer to my [Git Tutorial](/lectures/Using_Git.pdf).

The course repository is going to continuously get updated and new exercises and deliverables will get added on to it.  You can either manually copy the files over, or you can use the more sophisticated method of [syncing your repository to mine](/exercises/1/sync-instructions.md).  If you know Gavin, please thank him for contributing this set of instructions.
